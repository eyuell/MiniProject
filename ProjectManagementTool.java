...
public class ProjectManagementTool {
    ...
    public void printMenuOption(){
        ...
        System.out.println("12. Monitor Participation");
        System.out.println("13. Monitor Risk");
        System.out.println("14. Edit Information");
    ...
    public void run() throws Exception {
      ...
      final int MONITOR_FINANCES=10;
        final int MONITOR_TIME_SPENT = 11;
        final int MONITOR_PARTICIPATION = 12;
        final int MONITOR_RISK = 13;
        final int EDIT_INFO = 14;
        final int QUIT = 15;
    ...
    public void editInfo(){
        ...
        System.out.println("1.TeamMember");
        ...
        case 1:
        	...
        	System.out.println("Teammember: Do you want to change:");
        	System.out.println("1.ID");
        	System.out.println("2.Name");
        	int option2 = 0;
        	switch(option2) {
        	case 1:
        		System.out.println("Type in Id of the teammember you want to edit");
        		...
        		while (! teamMemberIDExists(currentProject, teammemberID)) {
        			...
        			TeamMember member = retrieveTeamMember(currentProject, teammemberID);
        			member.setId(newID);
        		break;
        	case 2:
        		...
        		System.out.println("Type in the new name of the teammember");
        		String name = new KeyboardInput().Line();
        		TeamMember teammember = retrieveTeamMember(currentProject, memberID);
        ...
        case 2:
        	...
        	System.out.println("3.Type of task");
        	
        	int option3 = 0;
        	switch(option3) {
        	case 1:
        		
        		System.out.println("Type in the new name of the task");
        		String taskName = new KeyboardInput().Line();
        		task.setName(taskName);
        		break;
        	case 2:
        		
        		System.out.println("Type in the new ID of the task");
        		String newID = new KeyboardInput().Line();
        		task.setId(newID);
        		break;
        	case 3:
        		int newTaskType = typeOfTask();
        		task.setTypeOfTask(newTaskType);
        		break;
        		default:
        			System.out.println("Invalid Option");
        	}
